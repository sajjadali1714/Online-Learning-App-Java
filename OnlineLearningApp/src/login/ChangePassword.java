...
public class ChangePassword extends javax.swing.JFrame {
    ...
    public boolean isValidate() {
        ...
        try {
            ...
            else if (txtConfirmPassword.getPassword().length < 5) {
                MsgBox.showMsg("Confirm Password must be at least 5 characters.");
                v_retuen = false;
            } else if (!(Arrays.equals(txtConfirmPassword.getPassword(), txtNewPassword.getPassword()))) {                
                MsgBox.showMsg(" New password and confirm password must be same.");
                v_retuen = false;
            } else {
                v_retuen = true;
            }            
    ...
    private boolean updatePassword(int user_id, String pwd){
        ...
        try {
            ...
            v_return = dbOperations.UpdateRecord(sql);            
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/chngPwdPage.png"))); // NOI18N
        ...
        btnChangePassword.setBackground(new java.awt.Color(51, 153, 255));
        btnChangePassword.setFont(new java.awt.Font("Segoe UI", 3, 14)); // NOI18N
        btnChangePassword.setForeground(new java.awt.Color(242, 242, 242));
        btnChangePassword.setText("Save");
        btnChangePassword.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 1, true));
        ...
        txtNewPassword.setBackground(new java.awt.Color(244, 244, 244));
        txtNewPassword.setFont(new java.awt.Font("Segoe UI", 2, 14)); // NOI18N
        txtNewPassword.setForeground(new java.awt.Color(56, 56, 56));
        txtNewPassword.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtNewPassword.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(56, 56, 56), 1, true));
        txtNewPassword.setCaretColor(new java.awt.Color(56, 56, 56));

        txtConfirmPassword.setBackground(new java.awt.Color(244, 244, 244));
        txtConfirmPassword.setFont(new java.awt.Font("Segoe UI", 2, 14)); // NOI18N
        txtConfirmPassword.setForeground(new java.awt.Color(56, 56, 56));
        txtConfirmPassword.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtConfirmPassword.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(56, 56, 56), 1, true));
        txtConfirmPassword.setCaretColor(new java.awt.Color(56, 56, 56));
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                            ...
                            .addComponent(txtConfirmPassword, javax.swing.GroupLayout.PREFERRED_SIZE, 380, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel6Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jLabel11, jLabel12});
    ...
    private void btnChangePasswordActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        try {                      
            if (isValidate() == true) {                
                if (updatePassword(GlobalVariable.getUserID(), String.valueOf(txtNewPassword.getPassword())) == true){
                    resetControlls();
                    MsgBox.showMsg("Password Changed..");                    
                }
            }
    ...
    public static javax.swing.JButton btnChangePassword;
