...
public class UpdateUserProfile extends javax.swing.JFrame {
    ...
    public boolean isValidate() {
        ...
        try {            
            if (txtFullName.getText().length() < 5) {
                MsgBox.showMsg("Name must be at least 5 characters.");
                v_retuen = false;
    ...
    private boolean UpdateUserInfo(int user_id){
        boolean v_return = false;
        try {
            String sql = "";
            sql = "update  tbl_user "
                    + " set fullname = '" + txtFullName.getText() + "',"
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Update User Info");
        ...
        jPanel6Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jLabel10, jLabel11, jLabel12, txtEmail, txtFullName});
    ...
    private void btnChangePasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChangePasswordActionPerformed
        try {
            if (isValidate() == true) {                
                if (UpdateUserInfo(GlobalVariable.getUserID()) == true){
                    resetControlls();
                    MsgBox.showMsg("Profile Updated..");    
